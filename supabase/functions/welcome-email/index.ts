...
//   }
// });
// pages/api/welcome-email.ts

import type { NextApiRequest, NextApiResponse } from 'next';
import { Resend } from 'resend';

const resend = new Resend(process.env.RESEND_API_KEY || '');
const SITE_URL = process.env.SITE_URL || 'https://your-default-url.com';
  ...
  try {
    ...
    <body>
           <div class="container">
             ...
             <div style="text-align: center; margin-top: 30px;">
               <a href="${SITE_URL}/dashboard" style="display: inline-block; background: #f43f5e; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none;">
              Start Your Journey
            </a>
             </div>
                         <p style="margin-top: 30px;">               If you have any questions, feel free to reach out to our support team.             </p>
                         <p>Best regards,<br>The MindfulMingle Team</p>           </div>         </body>
      </html>
    `;
