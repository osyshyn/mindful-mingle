...
const Reports = () => {
    ...
    try {
      ...
      const processedData = data.map(relationship => ({
        ...
        stress_level: relationship.biometric_data?.length
          ? relationship.biometric_data.reduce((acc, curr) => acc + (curr.stress_level || 0), 0) / relationship.biometric_data.length
          : undefined
      }));
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Relationship Reports</h1>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
        <div className="p-6 bg-rose-50 border-b border-rose-100">
          ...
          <p className="text-gray-600 mt-2">
            Interactive visualization of your relationships and their health metrics
          </p>
        </div>
          ...
          {relationships.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                Add relationships and complete assessments to see your relationship web
              </p>
            </div>
          ) : (
          ...
          >
            ...
            <div className="mt-2 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">{relationship.latest_score}%</span>
              </div>
              {relationship.stress_level !== undefined && (
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">Average Stress Level:</span>
                  <span className="font-medium">{Math.round(relationship.stress_level)}%</span>
                </div>
              )}
            </div>
          </div>
