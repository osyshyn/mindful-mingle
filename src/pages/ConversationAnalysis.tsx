...
import { supabase } from '../lib/supabase';
import { Sentiment, SentimentAnalysis } from '../interfaces/interfaces';
import toast from 'react-hot-toast';

const getSentimentIcon = (sentiment: Sentiment) => {
  const icons = {
    positive: <ThumbsUp className='h-6 w-6 text-green-500' />,
    negative: <ThumbsDown className='h-6 w-6 text-red-500' />,
      ...
      <div className='bg-white rounded-xl shadow-md overflow-hidden'>
        ...
        <div className='p-6'>
          <div className='mb-6'>
            ...
            />
            <p className='text-sm text-gray-500 mt-2'>
              Format: Name: Message Example: John: Hey, how are you doing?
              Sarah: I'm good, thanks for asking!
            </p>
          </div>
